...
const statDefs = [
    ...
    { value: '30+', labelKey: 'home.statBuses' },
    ...
    return (
        <div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 text-center">
                    {statDefs.map((s) => (
                        <div key={s.labelKey}>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t(s.labelKey)}</p>
                        </div>
                    ))}
                </div>
                ...
                {/* How it works */}
                <div className="mb-16">
                    <h2 className="font-display text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2 text-center">{t('home.howItWorksTitle')}</h2>
                    <p className="text-gray-500 dark:text-gray-400 text-center mb-8">{t('home.howItWorksSubtitle')}</p>
                    <div className="grid md:grid-cols-3 gap-6">
                        {howItWorksDefs.map((step, i) => (
                            <div key={step.titleKey} className="group relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 text-center hover:shadow-xl hover:shadow-brand-900/10 hover:-translate-y-1 hover:border-brand-200 dark:hover:border-brand-500 transition-all duration-300">
                                ...
                                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1.5">{t(step.titleKey)}</h3>
                ...
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-6">{t('home.bookJourneyDesc')}</p>
                        ...
                        {popularRoutes.map((r) => (
                            ...
                            >
                                ...
                                <div className="relative h-full flex flex-col justify-end p-5">
                                    ...
                                    <p className="text-white/80 text-sm mb-3">{r.duration} {t('home.journeySuffix')}</p>
