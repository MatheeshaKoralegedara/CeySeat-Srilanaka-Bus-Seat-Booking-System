...
public class EmailService {
    ...
    private String htmlBody(String code, int expiryMinutes) {
        return "<!DOCTYPE html>"
                ...
                + "<span style=\"color:#ffffff;font-size:20px;font-weight:700;letter-spacing:0.5px;\">CeySeat Bus Seat Booking Platform</span>"
                + "</td></tr>"
                ...
                + "<span style=\"display:inline-block;padding:14px 28px;background-color:#f0fdf4;border:1px solid #87c5f8;border-radius:8px;"
